export const ARTICLE_REACTION_PAGES = ["upsell-kr", "upsell-tw", "upsell-jp"] as const;
...
export function getArticleReactionPage(pathname: string): ArticleReactionPage | null {
  const match = /^\/korean-skin-treatments\/(upsell-kr|upsell-tw|upsell-jp)(?:\/cards)?\/?$/.exec(pathname);
